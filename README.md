# cs102-F2020-practical4-starter
...
* [Practical Assignment Tasks](#practical-assignment-tasks)
  ...
  + [Performing Mathematical Computations with Higher-Order Functions](#performing-mathematical-computations-with-higher-order-functions)
  + [Running a Test Suite for a General-Purpose Mathematical Computing Program](#running-a-test-suite-for-a-general-purpose-mathematical-computing-program)
...
- To use the `map` higher-order function to perform multiple computations
- To implement Pytest test cases that test mathematical functions
...
`Allegheny-Computer-Science-102-Fall-2020/computer-science-102-fall-2020-practical-4-gkapfham`.
...
```
git clone git@github.com:Allegheny-Computer-Science-102-F2020/computer-science-102-fall-2020-practical-4-gkapfham.git
```
...
### Performing Mathematical Computations with Higher-Order Functions

For this practical assignment you are going to design, implement and test a
program that, for a given input function name, applies that function to a range
of generated numerical values. This assignment will required you to combine your
knowledge of functions, higher-order functions, conditional logic, and
...
the Python program with the command `poetry run python supercomputer --start 1
--stop 10 factorial` it will produce the following output:
...
The name of the function is factorial
  ...
  This is the output from the factorial function:
...
However, you could run the completed version of the program with the command
`poetry run python supercomputer --start 1 --stop 10 negate` and it would
produce the following output:

```
Using a range of values between and inclusive 1 and an exclusive 10! 💻

The name of the function is negate

  This is the output from the negate function:
...
When you check the source code in the `compute.py` file you will see that it
should provide an implementation of the following mathematical functions:
...
source code line `function_to_call = getattr(compute, function)`. Specifically,
make sure that you understand what happens when you specify on the command-line
of this program the name of a function that does not exist inside of the
`compute.py` file. For instance, can you explain the program output that you see
when you run the command `poetry run python supercomputer --start 1 --stop 10
squared`? Is there a way to improve the program so that it does not crash and
produce this output?

The second noteworthy aspect of this program is its use of the higher-order
function called map. As you work on this assignment, make sure that you
understand the purpose of the `result = map(function_to_call, range(start,
stop))` inside of the program's source code. What is the behavior, input, and
output of the `map` function? What is the behavior, input, and output of the
`range` function? Why do we call the `map` function a higher-order function? As
you refine your knowledge of these technical topics, please make sure to try the
provided Python program with all of its supported functions, ensuring that it
works correctly. Ultimately, your task for this assignment is to find and
address all of the `TODO` markers inside of the provided source code. If you
have questions about any aspect of this project, please schedule a meeting with
the course instructor to discuss them during office hours.

### Running a Test Suite for a General-Purpose Mathematical Computing Program
...
rootdir: /home/gkapfham/working/teaching/github-classroom/Allegheny-Computer-Science-102-F2020/solutions/cs102-F2020-practical4-solution/supercomputer
collected 9 items
...
- The command `cd supercomputer; poetry install; poetry run python supercomputer --start 1 --stop 10 square; cd ..` executes correctly
- The compute.py in supercomputer/supercomputer has at least 2 multiple-line Python comment(s)
- The compute.py in supercomputer/supercomputer has at least 7 single-line Python comment(s)
- The compute.py in supercomputer/supercomputer has exactly 0 of the `TODO` fragment
- The file compute.py exists in the supercomputer/supercomputer directory
- The file \_\_main\_\_.py exists in the supercomputer/supercomputer directory
- The file reflection.md exists in the writing directory
- The file test_compute.py exists in the supercomputer/tests directory
- The \_\_main\_\_.py in supercomputer/supercomputer has at least 2 multiple-line Python comment(s)
- The \_\_main\_\_.py in supercomputer/supercomputer has at least 4 single-line Python comment(s)
- The \_\_main\_\_.py in supercomputer/supercomputer has exactly 0 of the `TODO` fragment
- The \_\_main\_\_.py in supercomputer/supercomputer has exactly 1 of the `Argument(...)` fragment
- The \_\_main\_\_.py in supercomputer/supercomputer has exactly 1 of the `getattr(` fragment
- The \_\_main\_\_.py in supercomputer/supercomputer has exactly 1 of the `map(` fragment
- The \_\_main\_\_.py in supercomputer/supercomputer has exactly 1 of the `range(` fragment
- The \_\_main\_\_.py in supercomputer/supercomputer has exactly 1 of the `run(main)` fragment
...
- The reflection.md in writing has exactly 5 of the `code_block` tag
- The repository has at least 5 commit(s)
- The test_compute.py in supercomputer/tests has at least 10 multiple-line Python comment(s)
- The test_compute.py in supercomputer/tests has exactly 0 of the `TODO` fragment

```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 25/25 (100%) of checks for cs102-F2020-practical4! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-102-F2020/cs102-F2020-practical4-starter/
```
